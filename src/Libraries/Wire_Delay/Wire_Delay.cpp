extern "C" {
  ...
  #include "twi_delay.h"
	...
	uint8_t delayAfterAddress;
	uint8_t delayAfterData;
	uint8_t delayAfterRead;
	uint8_t delayAfterStop;
}

#include "Wire_Delay.h"
...
uint8_t TwoWire::delayAfterAddress = 0;
uint8_t TwoWire::delayAfterData = 0;
uint8_t TwoWire::delayAfterRead = 0;
uint8_t TwoWire::delayAfterStop = 0;
...
void TwoWire::setDelayTWI(uint8_t delayAfterAddress, uint8_t delayAfterData, uint8_t delayAfterRead, uint8_t delayAfterStop) {
  TwoWire::delayAfterAddress = delayAfterAddress;
  TwoWire::delayAfterData = delayAfterData;
  TwoWire::delayAfterRead = delayAfterRead;
  TwoWire::delayAfterStop = delayAfterStop;
}

void TwoWire::clearDelayTWI() {
  setDelayTWI(0, 0, 0, 0);
}

bool TwoWire::isSetDelayTWI() {
  return (delayAfterAddress || delayAfterData || delayAfterRead || delayAfterStop);
}
